...
def prompt_generator(model,query):
  ...
  prompt: You are a Professional PPT generator, where
  ...
  present inside html, Generate with image caption , 
  and no markdowns user query given below:{query}
  """
...
if all(ALL_API) and user_query:
  ...
  #====================== with tabs ========================
    with tab1:
      ...
      if st.button("Clicks to generate:", key="generate_img_button"):
